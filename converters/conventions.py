...
class ConventionConverter:
    ...
    @classmethod
    def get_multiplier(cls, channel: str, from_convention: str, 
                      to_convention: str) -> int:
        """
    ...
    @classmethod
    def convert_channel_data(cls, data: np.ndarray, channel: str,
                            from_convention: str, to_convention: str) -> np.ndarray:
        """
    ...
    @classmethod
    def convert_dataset_convention(cls, dataset: Any, 
                                  target_convention: str) -> Any:
        """
    ...
    def convert_channel_convention(cls, channels: List[str], data: np.ndarray,
                                  ...
                                  target_convention: str) -> np.ndarray:
        """
