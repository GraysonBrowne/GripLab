...
class WidgetFactory:
    ...
    @staticmethod
    def create_button(name: str, button_type: str = "primary", **kwargs) -> pn.widgets.Button:
...
class PlotControlWidgets:
    ...
    def __init__(self):
        ...
        self.cmd_multi_selects = [
            pn.widgets.MultiSelect(options={}, size=8, sizing_mode="stretch_width", height=100, min_width=80)
            for _ in range(4)
        ]
        ...
        # Plot action buttons
        self.plot_button = wf.create_button("Plot Data", sizing_mode="stretch_width", margin=(5, 10, 5, 7))
        self.settings_button = wf.create_button("⚙️", button_type="default", width=43, margin=(5, 0, 5, 15))
...
class DataInfoWidgets:
    ...
    def __init__(self):
        ...
        self.rim_width_input = pn.widgets.IntInput(name="Rim Width [in]", width=100, disabled=True)
        self.notes_input = pn.widgets.TextAreaInput(name="Notes", sizing_mode="stretch_width", disabled=True)
        self.update_button = wf.create_button("Update Dataset", sizing_mode="stretch_width", disabled=True)
...
class PlotSettingsWidgets:
    ...
    def __init__(self):
        ...
        self.x_label = pn.widgets.TextInput(
            name="X-Axis Label", placeholder="Channel [unit]", sizing_mode="stretch_width"
        )
        self.y_label = pn.widgets.TextInput(
            name="Y-Axis Label", placeholder="Channel [unit]", sizing_mode="stretch_width"
        )
        self.z_label = pn.widgets.TextInput(
            name="Z-Axis Label", placeholder="Channel [unit]", sizing_mode="stretch_width"
        )
        self.c_label = pn.widgets.TextInput(
            name="Colorbar Label", placeholder="Channel [unit]", sizing_mode="stretch_width"
        )
        ...
        # Color map
        color_map_options = {
            "Jet": ["#010179", "#022291", "#0450b2", "#0aa5c1", "#4ffdc8",
                   "#c8ff3a", "#ffaf02", "#fc1d00", "#c10000", "#810001"],
...
class AppSettingsWidgets:
    ...
    def __init__(self, config):
        ...
        self.save_button = pn.widgets.Button(
            name="Save Settings", button_type="primary",
            margin=(10, 15, 0, 15), width=200
        )